...
Namespace Toyota.eCRB.SystemFrameworks.Web.Controls
    ...
    Public Class CheckMark
        ...
        Public Property Position As CheckMarkPosition
            Get
                If ViewState("Position") Is Nothing Then
                    Return CheckMarkPosition.Left
                Else
                    Return CType(ViewState("Position"), CheckMarkPosition)
                End If
            End Get
            Set(value As CheckMarkPosition)
        ...
        Protected Overrides Sub OnPreRender(e As System.EventArgs)
            ...
            End If
            options.Add("checkIconPosition", ResolveClientUrl(Me.Position.ToString().ToLower(CultureInfo.InvariantCulture)))
            ...
            End If
            Page.ClientScript.RegisterStartupScript(Me.GetType(), Me.ClientID, Common.GetJqueryPluginBinding(Me.ClientID, "CheckMark", options, Me.Enabled), True)
        End Sub
