...
<Assembly: WebResource("ItemSelector.js", "application/x-javascript")> 
    ...
    Public Class ItemSelector
        ...
        Protected Overrides Sub OnPreRender(e As System.EventArgs)
            ...
            If (Me.SelectedItem IsNot Nothing) Then
                _trigger.Text = Me.SelectedItem.Text
                Dim iconUrl As String = Me.SelectedItem.Attributes("IconUrl")
                If (iconUrl <> Nothing) Then
                    _trigger.IconUrl = iconUrl
                End If
            Else
            ...
            For Each item As ListItem In Me.Items
                ...
                itemFrame.Attributes.Add("class", "icrop-ItemSelector-item")
                itemFrame.Attributes.Add("data-value", item.Value)
                itemFrame.Attributes.Add("data-selector", Me.ClientID)
            ...
            Page.ClientScript.RegisterClientScriptResource(Me.GetType(), "ItemSelector.js")
        End Sub

        Protected Overrides Sub AddAttributesToRender(writer As System.Web.UI.HtmlTextWriter)
            MyBase.AddAttributesToRender(writer)
            writer.AddAttribute("class", "icrop-ItemSelector")
