...
Public Class MasterPageTest
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If [Enum].IsDefined(GetType(FooterMenuCategory), "TCV") Then
            'TCVボタンを設定（イベントハンドラ割り当て）
            Dim tcv As FooterMenuCategory = [Enum].Parse(GetType(FooterMenuCategory), "TCV")
            Dim tcvButton As CommonMasterFooterButton = commonMaster.GetFooterButton(tcv)
