...
(function ($) {
    ...
    pluginImpl.prototype = {
        ...
        getPosition: function (elem) {
            var attr = elem.get(0).style["-webkit-transform"];
            ...
            if (duration) {
                ...
                animationTimer = setInterval(function () {
                    ...
                    if (duration < passed) {
                        ...
                        currentTop += step;
                        elem.css("-webkit-transform", "translate3d(" + left + "px, " + currentTop + "px, 0px)");
                    }
                }, 50);
            } else {
                elem.css("-webkit-transform", "translate3d(" + left + "px, " + top + "px, 0px)");
            }
        },
        ...
        create: function (options, elem) {
            ...
            this.inner = $('<div class="icrop-CustomRepeater-inner" style="position:relative;-webkit-transform:translate3d(0px,0px,0px);" />').appendTo(element);
