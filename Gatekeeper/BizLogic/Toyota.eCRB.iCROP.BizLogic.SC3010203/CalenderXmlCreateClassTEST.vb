...
Public Class ClassLibraryBusinessLogicTEST
    ...
    ''' <remarks></remarks>
    Public Function GetCalender(ByVal startDate As Date, ByVal endDate As Date, ByVal userAccount As String, ByVal operationCode As String) As String
    ...
    Public Function GetFll() As String
        ...
        Dim func As Func(Of String) = _
            Function() As String
                ...
                xmlstring2.Append("  <DealerCode>44B40</DealerCode>")
                xmlstring2.Append("  <BranchCode>01</BranchCode>")
                'xmlstring2.Append("  <ScheduleID>9000024569</ScheduleID>")
                xmlstring2.Append("  <ScheduleID>9000024712</ScheduleID>")
        ...
        xmlstring.Append(Me.CreateVTodo("C1様", "2", "", "21:00:00", 1, "0", ""))
        xmlstring.Append("</Detail>")

        xmlstring.Append("<Detail>")
        xmlstring.Append(func.Invoke())
        xmlstring.Append(Me.CreateVTodo("C2様", "2", "", "21:00:00", 2, "0", "0"))
        xmlstring.Append("</Detail>")

        xmlstring.Append("<Detail>")
        xmlstring.Append(func.Invoke())
        xmlstring.Append(Me.CreateVTodo("C3様", "2", "", "21:00:00", 3, "0", "0"))
        xmlstring.Append("</Detail>")

        xmlstring.Append("<Detail>")
        xmlstring.Append(func.Invoke())
        xmlstring.Append(Me.CreateVTodo("C4様", "2", "", "21:00:00", 4, "0", "0"))
        xmlstring.Append("</Detail>")

        xmlstring.Append("<Detail>")
        xmlstring.Append(func.Invoke())
        xmlstring.Append(Me.CreateVTodo("C5様", "2", "", "21:00:00", 5, "0", "0"))
        xmlstring.Append("</Detail>")

        xmlstring.Append("<Detail>")
        xmlstring.Append(func.Invoke())
        xmlstring.Append(Me.CreateVTodo("C6様", "2", "", "21:00:00", 6, "0", "0"))
        xmlstring.Append("</Detail>")
        ...
        'xmlstring.Append("<Detail>")
        'xmlstring.Append(func.Invoke())
        'xmlstring.Append(Me.CreateVTodo("今日 ", "2", "", "12:00:00", 6, "0", "0", "1"))
        'xmlstring.Append("</Detail>")

        'xmlstring.Append("<Detail>")
        'xmlstring.Append(func.Invoke())
        'xmlstring.Append(Me.CreateVTodo("昨日 ", "2", "", Date.Now.AddDays(-1).ToString("yyyy/MM/dd") & " 12:00:00", 6, "0", "0", "1"))
        'xmlstring.Append("</Detail>")

        'xmlstring.Append("<Detail>")
        'xmlstring.Append(func.Invoke())
        'xmlstring.Append(Me.CreateVTodo("２日前 ", "2", "", Date.Now.AddDays(-2).ToString("yyyy/MM/dd") & " 12:00:00", 6, "0", "0", "1"))
        'xmlstring.Append("</Detail>")

        'xmlstring.Append("<Detail>")
        'xmlstring.Append(func.Invoke())
        'xmlstring.Append(Me.CreateVTodo("去年 ", "2", "", Date.Now.AddYears(-1).ToString("yyyy/MM/dd") & " 12:00:00", 6, "0", "0", "1"))
        'xmlstring.Append("</Detail>")
    ...
    Public Function CreateVTodo(ByVal title As String, ByVal location As String, ByVal stDate As String, ByVal edDate As String, ByVal contactNo As Integer, ByVal eventFlg As String, ByVal compFlg As String, Optional ByVal timeFlg As String = "1") As String
        Dim xmlstring As StringBuilder = New StringBuilder()
        Dim dtToday As Date = Date.Now
