<%@ Page Language="VB" MasterPageFile="~/Master/NoHeaderMasterPage.master" AutoEventWireup="false" Inherits="Toyota.eCRB.SystemFrameworks.Web.SC3010302" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="content" Runat="Server">
    <div style="text-align:center; padding:1em; color:Red;">
 		<div>
            <icrop:CustomLabel ID="NoAccessLiteral" runat="server" TextWordNo="2" />
