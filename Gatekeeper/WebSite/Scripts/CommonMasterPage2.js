...
function blinkImage() {
    ...
    setTimeout(function () { targetElement.style.opacity = 1.0; }, 0);
    setTimeout(function () { targetElement.style.opacity = 0.9; }, 100);
    setTimeout(function () { targetElement.style.opacity = 0.8; }, 200);
    setTimeout(function () { targetElement.style.opacity = 0.7; }, 300);
    setTimeout(function () { targetElement.style.opacity = 0.6; }, 400);
    setTimeout(function () { targetElement.style.opacity = 0.5; }, 500);
    setTimeout(function () { targetElement.style.opacity = 0.4; }, 600);
    setTimeout(function () { targetElement.style.opacity = 0.3; }, 700);
    setTimeout(function () { targetElement.style.opacity = 0.4; }, 1400);
    setTimeout(function () { targetElement.style.opacity = 0.5; }, 1500);
    setTimeout(function () { targetElement.style.opacity = 0.6; }, 1600);
    setTimeout(function () { targetElement.style.opacity = 0.7; }, 1700);
    setTimeout(function () { targetElement.style.opacity = 0.8; }, 1800);
    setTimeout(function () { targetElement.style.opacity = 0.9; }, 1900);
    setTimeout(function () { targetElement.style.opacity = 1.0; }, 2000);
