...
Imports Toyota.eCRB.iCROP.DataAccess.IC3810201.IC3810201DataSet
Imports Toyota.eCRB.iCROP.DataAccess.IC3810201.IC3810201DataSetTableAdapters

''' <summary>
''' IC3810201
''' </summary>
''' <remarks>顧客連携</remarks>
Public Class IC3810201BusinessLogic
    ...
    ''' </history>
    <EnableCommit()>
    Public Function AddCustomerSave(ByVal rowIN As IC3810201inCustomerSaveRow) As Long
        Try
            ''引数をログに出力
            ...
            Using da As New IC3810201DataTableAdapter
                ''来店実績番号の入力チェック
                If rowIN.IsVISITSEQNull = False _
                    AndAlso (rowIN.VISITSEQ > 0) Then
                    ''来店実績番号が入力されている場合、修正更新
                    ''サービス来店者キー情報の取得
                    Using dtVisit As IC3810201VisitKeyDataTable = da.GetVisitKey(rowIN)
                        ...
                        End If
                        Dim rowVK As IC3810201VisitKeyRow = DirectCast(dtVisit.Rows(0), IC3810201VisitKeyRow)
