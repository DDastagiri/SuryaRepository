...
#Region "来店実績更新_商談または納車作業開始"
    ...
    Public Sub UpdateVisitSalesStart( _
        ...
        Catch ex As OracleExceptionEx
            Logger.Error("UpdateSalesVisitBusinessLogic.UpdateVisitSalesStart_010")
...
#Region "来店実績更新_商談または納車作業終了"
    ...
    Public Sub UpdateVisitSalesEnd( _
        ...
        Try
            ...
            ' データベースの操作中に例外が発生した場合
        Catch ex As OracleExceptionEx
            Logger.Error("UpdateSalesVisitBusinessLogic.UpdateVisitSalesEnd_013")
...
#Region "来店実績更新_顧客登録"
    ...
    Public Sub UpdateVisitCustomerInfo( _
        ...
        Try
            ...
            '    ' データベースの操作中に例外が発生した場合
        Catch ex As OracleExceptionEx
            Logger.Error("UpdateSalesVisitBusinessLogic.UpdateVisitCustomerInfo_005")
...
#Region "来店実績更新_ログイン"
    ...
    Public Function UpdateVisitLogin( _
        ...
        Try
            ...
            ' データベースの操作中に例外が発生した場合
        Catch ex As OracleExceptionEx
            Logger.Error("UpdateSalesVisitBusinessLogic.UpdateVisitLogin_004")
...
#Region "商談または納車作業開始前の来店実績連番の取得"
    ...
    Public Function GetVisitSeqBeforeSalesStart( _
        ...
        Try
            ...
            ' データベースの操作中に例外が発生した場合
        Catch ex As OracleExceptionEx
            Logger.Error("UpdateSalesVisitBusinessLogic.GetVisitSeqBeforeSalesStart_009")
