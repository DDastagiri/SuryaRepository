...
''' </summary>
''' <remarks></remarks>
Public Enum DBCompletionFlg As Integer
...
Public Enum DataBaseErrorCode As Integer
    ...
    ''' <summary>Todo削除フラグ更新(受注後工程)SQLエラー</summary>
    UpdateAfterOrderDeleteFlgCalTodoItemSqlError = 26

    ''' <history>2014/07/23 SKFC 渡邊 NEXT_STEP CalDAV 仕様変更 START</history>
    ''' <summary>イベント削除フラグ更新(受注後工程)SQLエラー</summary>
    UpdateAfterOrderDeleteFlgCalEventItemSqlError = 27
...
Public Enum ElementName As Integer
    ...
    ''' <summary>ContactName要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    ContactName = 46

    ''' <summary>ActOdrName要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    ActOdrName = 47

    ''' <summary>OdrDiv要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    OdrDiv = 48

    ''' <summary>AfterOdrActID要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    AfterOdrActID = 49

    ''' <summary>AfterOrderRegistSchedule要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    RegistAfterOrderSchedule = 50
...
Public NotInheritable Class ConstCode
    ...
    ''' <summary>ProcessDiv要素</summary>
    ''' <history>2012/03/07 SKFC 加藤 【SALES_2】受注後工程の対応 START</history>
    Public Const XmlNameProcessDiv As String = "ProcessDiv"

    ''' <summary>ResultDate要素</summary>
    ''' <history>2012/03/07 SKFC 加藤 【SALES_2】受注後工程の対応 START</history>
    Public Const XmlNameResultDate As String = "ResultDate"

    ''' <summary>AfterOrderRegistSchedule要素</summary>
    '''<history>2014/04/03 SKFC 渡邊 NETSTEP_CALDAV STRAT</history>
    Public Const XmlNameRegistAfterOrderSchedule As String = "RegistAfterOrderSchedule"

    ''' <summary>ContactName要素</summary>
    '''2014/04/03 SKFC渡邊 NEXTSTEP_CALDAV START
    Public Const XmlNameContactName As String = "ContactName"

    ''' <summary>ActOdrName要素</summary>
    '''2014/04/03 SKFC渡邊 NEXTSTEP_CALDAV START
    Public Const XmlNameActOdrName As String = "ActOdrName"

    ''' <summary>OdrDiv要素</summary>
    '''<history>2014/04/03 SKFC 渡邊 NETSTEP_CALDAV STRAT</history>
    Public Const XmlNameOdrDiv As String = "OdrDiv"

    ''' <summary>AfterOderActID要素</summary>
    '''<history>2014/04/03 SKFC 渡邊 NETSTEP_CALDAV STRAT</history>
    Public Const XmlNameAfterOdrActID As String = "AfterOdrActID"
    ...
    Public Const TodoItemTableProcessDiv As String = "PROCESSDIV"

    ''' <summary>接触方法名要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const TodoItemTableContactName As String = "CONTACT_NAME"

    ''' <summary>受注後活動名称要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const TodoItemTableActOdrName As String = "ACT_ODR_NAME"

    ''' <summary>受注区分要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const TodoItemTableOdrDiv As String = "ODR_DIV"

    ''' <summary>受注後活動ID要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const TodoItemTableAfterOdrActID As String = "AFTER_ODR_ACT_ID"
    ...
    ''' <summary>工程区分要素</summary>
    ''' <history>2012/03/01 SKFC 加藤 【SALES_2】受注後工程の対応 START</history>
    Public Const EventItemTableProcessDiv As String = "PROCESSDIV"

    ''' <summary>接触方法名要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const EventItemTableContactName As String = "CONTACT_NAME"

    ''' <summary>受注後活動名称要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const EventItemTableActOdrName As String = "ACT_ODR_NAME"

    ''' <summary>受注区分要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const EventItemTableOdrDiv As String = "ODR_DIV"

    ''' <summary>受注後活動ID要素</summary>
    ''' <history>2014/04/03 SKFC 渡邊 NEXT_STEP START</history>
    Public Const EventItemTableAfterOdrActID As String = "AFTER_ODR_ACT_ID"
