' "データ格納クラス"
' 取得XML内に存在する要素を格納する。
Public Class XmlRegistSchedule
    ...
    Private _detailList As List(Of XmlDetail)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public ReadOnly Property DetailList As List(Of XmlDetail)
        Get
            Return _detailList
        End Get
    End Property
    ...
    Public Sub InitialDetailList()
        _detailList = New List(Of XmlDetail)
    End Sub
