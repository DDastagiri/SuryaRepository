...
'更新: 2014/03/03 TMEJ y.nakamura 受注後フォロー機能開発 $03
Public Class XmlRequestNotice
    ...
    ' $03 start 受注後フォロー機能開発
    ''' <summary>
    ''' 受注後活動コード
    ''' </summary>
    ''' <remarks></remarks>
    Private _AfterOdrActCd As String
    ' $03 end 受注後フォロー機能開発
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Property AfterOdrActCd() As String
        Get
            Return _AfterOdrActCd
        End Get
        Set(ByVal value As String)
            _AfterOdrActCd = value
        End Set
    End Property
    ' $05 end 受注後フォロー機能開発
