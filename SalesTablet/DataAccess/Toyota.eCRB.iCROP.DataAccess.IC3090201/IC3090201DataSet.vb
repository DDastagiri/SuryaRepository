...
#Region "スタッフ情報（スタンバイ）の取得"
        ...
        ''' <param name="dealerCode">販売店コード</param>
        ''' <param name="storeCode">店舗コード</param>
        ''' <returns>Push送信対象のスタッフ情報</returns>
        ''' <remarks></remarks>
        Public Function GetPushStaff(ByVal dealerCode As String, ByVal storeCode As String) _
                                          As IC3090201DataSet.IC3090201PushAccountDataTable
            'SQL組み立て
            Dim sql As New StringBuilder
            With sql
                .Append(" SELECT /* IC3090201_003 */")
            ...
            Using query As New DBSelectQuery(Of IC3090201DataSet.IC3090201PushAccountDataTable)("IC3090201_003")
                query.CommandText = sql.ToString()
                ...
                query.AddParameterWithTypeValue("STAFFSTATUS", OracleDbType.Char, "1")
                query.AddParameterWithTypeValue("DELFLG", OracleDbType.Char, "0")
                query.AddParameterWithTypeValue("OPERATIONCODE", OracleDbType.Long, "50")
