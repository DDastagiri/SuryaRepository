...
icropScript.ui = {
    ...
    noticeHandlers: {}, //setNoticeHandlerメソッドで登録されたコールバック関数
    ...
    //setNoticeの実行直後に呼び出されるJavaScript関数を登録する
    setNoticeHandler: function (name, callback) {
        icropScript.ui.noticeHandlers[name] = callback;
    ...
    setNotice: function () {
        ...
        //setNoticeHandlerメソッドで設定されたコールバック関数を呼び出す
        for (var name in icropScript.ui.noticeHandlers) {
            var handler = icropScript.ui.noticeHandlers[name];
