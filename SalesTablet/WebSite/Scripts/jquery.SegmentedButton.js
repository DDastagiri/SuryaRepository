...
(function ($) {
    ...
    pluginImpl.prototype = {
        ...
        create: function (options, elem) {
            ...
            element.children("li").bind("click." + pluginName, function (e) {
                ...
                if (self.options.select && (originalValue != newValue)) {
                    self.options.select.call(self.elem, newValue);
                }
            });
            element.children("li").children("input").css({
                "display": "none"
            });

            value = $("input[name='" + self.options.formName + "']:checked").val();
            $("input[name='" + self.options.formName + "']:checked").parent().addClass("icrop-selected");
            if (self.options.select) {
                self.options.select.call(self.elem, value);
            }
        },
