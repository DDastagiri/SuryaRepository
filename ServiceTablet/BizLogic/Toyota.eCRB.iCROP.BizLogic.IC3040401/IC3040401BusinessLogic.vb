...
#End Region
        ...
        Private Function SetHeadTable(ByVal headRow As RegistSchedule.HEADRow, ByVal RegistScheduleKey As Integer) As RegistSchedule.HEADRow
            ...
            headRow.COUNTRYCODE = My.Settings.CNTCD
        ...
        Private Function SendXmlByWebService(ByVal scheduleInfoDataSet As RegistSchedule, ByVal WebServiceUrl As String) As String
            ...
            Using sw As StringWriter = New StringWriter(culture)
                ...
                resultXmlDoc.LoadXml(CallWebServiceSite(lastSendXmlValue, WebServiceUrl))
        ...
        Private Function CallWebServiceSite(ByVal postData As String, ByVal WebServiceUrl As String) As String
            ...
            Dim req As System.Net.WebRequest = _
                System.Net.WebRequest.Create(WebServiceUrl + "/RegistSchedule")
            'メソッドにPOSTを指定
            req.Method = "POST"
        ...
        Private Sub writeInputValue()
            'Common
            Logger.Debug("ActionType:""" + P_CommonDr.ActionType + """")
            Logger.Debug("DealerCode:""" + P_CommonDr.DealerCode + """")
            Logger.Debug("BranchCode:""" + P_CommonDr.BranchCode + """")
            Logger.Debug("ScheduleId:""" + P_CommonDr.SCHEDULEID + """")
            Logger.Debug("ScheduleDivision:""" + P_CommonDr.ScheduleDivision + """")
            Logger.Debug("ActivityCreateStaffCode:""" + P_CommonDr.ActivityCreateStaffCode + """")
            Logger.Debug("CompleteFlg:""" + P_CommonDr.CompleteFlg + """")
            Logger.Debug("CompletionDate:""" + P_CommonDr.CompleteFlg + """")
            Logger.Debug("CustomerDivision:""" + P_CommonDr.CustomerDivision + """")
            Logger.Debug("CustomerId:""" + P_CommonDr.CustomerId + """")
            Logger.Debug("CustomerName:""" + P_CommonDr.CustomerName + """")
            Logger.Debug("NameTitle:""" + P_CommonDr.NameTitle + """")
            Logger.Debug("NameTitlePosition:""" + P_CommonDr.NameTitlePosition + """")
            Logger.Debug("DmsId:""" + P_CommonDr.DmsId + """")
            Logger.Debug("ReceptionDivision:""" + P_CommonDr.ReceptionDivision + """")
            Logger.Debug("ServiceCode:""" + P_CommonDr.ServiceCode + """")
            Logger.Debug("ServiceName:""" + P_CommonDr.ServiceName + """")
            Logger.Debug("MerchandiseCode:""" + P_CommonDr.MerchandiseCode + """")
            Logger.Debug("MerchandiseName:""" + P_CommonDr.MerchandiseName + """")
            Logger.Debug("StoreStatus:""" + P_CommonDr.StoreStatus + """")
            Logger.Debug("ReservationStatus:""" + P_CommonDr.ReservationStatus + """")
            Logger.Debug("ReservationStatusName:""" + P_CommonDr.ReservationStatus + """")

            'Schedule
            For Each p_scheduleRow As RegistSchedule.P_ScheduleRow In P_ScheduleInfoDt.Rows
                Logger.Debug("ActivityStaffBranchCode:""" + p_scheduleRow.ActivityStaffBranchCode + """")
                Logger.Debug("ActivityStaffCode:""" + p_scheduleRow.ActivityStaffCode + """")
                Logger.Debug("ReceptionStaffBranchCode:""" + p_scheduleRow.ReceptionStaffBranchCode + """")
                Logger.Debug("ReceptionStaffCode:""" + p_scheduleRow.ReceptionStaffCode + """")
                Logger.Debug("StartTime:""" + p_scheduleRow.StartTime + """")
                Logger.Debug("EndTime:""" + p_scheduleRow.EndTime + """")
                Logger.Debug("Memo:""" + p_scheduleRow.Memo + """")
                Logger.Debug("AlarmNo:""" + p_scheduleRow.AlarmNo + """")
                Logger.Debug("ContactNo:""" + p_scheduleRow.ContactNo + """")
                Logger.Debug("ContactName:""" + p_scheduleRow.ContactName + """")
                Logger.Debug("ComingFollowName:""" + p_scheduleRow.ComingFollowName + """")
                Logger.Debug("BackgroundColor:""" + p_scheduleRow.BackGroundColor + """")
                Logger.Debug("TodoId:""" + p_scheduleRow.TodoId + """")
            Next
