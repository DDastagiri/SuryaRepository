...
#End Region
    ...
    ''' </History>
    Public Function GetMyCustomerInfo(ByVal basicCustomerId As String, _
        ...
        Using da As New IC3080204DataSetTableAdapters.IC3080204DataTableTableAdapter
            ...
            Using commonClass As New SMBCommonClassBusinessLogic
                ...
                '基幹顧客IDに販売店コード＠を追加
                customerId = commonClass.ReplaceBaseCustomerCode(dealerCD, basicCustomerId)

            End Using

            'Using dt As IC3080204DataSet.IC3080204CustomerDataTable = da.GetMyCustomer(dealerCD, storeCD, basicCustomerId)

            Using dt As IC3080204DataSet.IC3080204CustomerDataTable = da.GetMyCustomer(customerId)
