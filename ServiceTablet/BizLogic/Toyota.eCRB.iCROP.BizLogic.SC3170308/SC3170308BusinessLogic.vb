...
Imports Toyota.eCRB.AddRepair.AddRepairConfirm.DataAccess.SC3170308DataSetTableAdapters

Public Class SC3170308BusinessLogic
...
#Region "メイン処理"
    ...
    Public Function GetUserInfo(ByVal inDealerCode As String, _
        ...
        Using da As New SC3170308DataTableAdapter
            'ユーザー情報取得
            Dim dt As SC3170308UserInfoDataTable = _
