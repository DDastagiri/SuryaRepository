...
#Region "共通定数"
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Private Const ReadFlg_Unread As String = "0"

        Private Const ReadFlg_read As String = "1"
...
#End Region
        ...
        Public Function InsertNoticeRequest(ByVal dr As IC3040801DataSet.IC3040801NoticeRequestRow) As Integer
            ...
            Dim query As DBUpdateQuery

            'DBUpdateQueryインスタンス生成
            Using queryTmp As New DBUpdateQuery("IC3040801_001")
                query = queryTmp
            End Using
            ...
            query.AddParameterWithTypeValue("REQCLASSID", OracleDbType.Int64, dr.REQCLASSID)
            ...
            query.AddParameterWithTypeValue("FLLWUPBOX", OracleDbType.Int64, dr.FLLWUPBOX)
            ' $01 start step2開発
        ...
        Public Function InsertNoticeInfo(ByVal dr As IC3040801DataSet.IC3040801NoticeInfoRow, ByVal noticeId As Long) As Integer
            ...
            'DBUpdateQueryインスタンス生成
            Using queryTmp As New DBUpdateQuery("IC3040801_003")
                query = queryTmp
            End Using
            ...
            'End If
            query.AddParameterWithTypeValue("READFLG", OracleDbType.Char, dr.READFLG)
        ...
        Public Function UpdateConfirmed(ByVal dr As IC3040801DataSet.IC3040801NoticeInfoRow) As Integer
            ...
            Using query As New DBUpdateQuery("IC3040801_005")
                ...
                With sql
                    ...
                    .Append("   SET READFLG = :READFLG_READ ")
                    '.Append("     , UPDATEDATE = SYSDATE")
                    ...
                    '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 START
                    '.Append("       READFLG = 0")
                    .Append("       READFLG = :READFLG_UNREAD ")
                    '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 END
                    .Append("   AND TOACCOUNT = :TOACCOUNT")
                    '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 START
                    .Append("   AND SENDDATE <= :SENDDATE")
                    '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 END
                End With
                ...
                '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 START
                query.AddParameterWithTypeValue("READFLG_READ", OracleDbType.Char, ReadFlg_read)
                query.AddParameterWithTypeValue("READFLG_UNREAD", OracleDbType.Char, ReadFlg_Unread)
                query.AddParameterWithTypeValue("SENDDATE", OracleDbType.Date, dr.SENDDATE.AddDays(1))
                query.AddParameterWithTypeValue("UPDATEDATE", OracleDbType.Date, dr.SENDDATE)
                '2014/04/14 TMEJ 丁 BTS-383 「通知履歴のレスポンスが遅い」対応 END
        ...
        ''' <returns>処理結果件数</returns>
        ''' <remarks></remarks>
        Public Function UpdateSupportStatus(ByVal dr As IC3040801DataSet.IC3040801NoticeInfoRow) As Integer
            ...
            'DBUpdateQueryインスタンス生成
            Using query As New DBUpdateQuery("IC3040801_009")
                'SQL組み立て
                Dim sql As New StringBuilder
                With sql
                    .Append("UPDATE /* IC3040801_009 */ ")
                    .Append("       TBL_NOTICEINFO ")
                    .Append("   SET SUPPORTSTATUS = :SUPPORTSTATUS")
                    .Append("     , UPDATEDATE = SYSDATE")
                    .Append("     , UPDATEACCOUNT = :UPDATEACCOUNT")
                    .Append("     , UPDATEID = :UPDATEID")
                    .Append(" WHERE ")
                ...
                query.AddParameterWithTypeValue("UPDATEACCOUNT", OracleDbType.Varchar2, dr.ACCOUNT)
                query.AddParameterWithTypeValue("UPDATEID", OracleDbType.Varchar2, dr.SYSTEM)
                query.AddParameterWithTypeValue("NOTICEID", OracleDbType.Char, dr.NOTICEID)
                query.AddParameterWithTypeValue("SUPPORTSTATUS", OracleDbType.Char, dr.SUPPORTSTATUS)
...
Partial Class IC3040801DataSet
    Partial Class IC3040801NoticeInfoDataTable
