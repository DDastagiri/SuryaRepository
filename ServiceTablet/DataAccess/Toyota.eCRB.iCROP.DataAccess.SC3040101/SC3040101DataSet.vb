...
Partial Class SC3040101DataSet
End Class

Namespace SC3040101DataSetTableAdapters
    Public Class SC3040101MessageInfoDataTableAdapter
        ...
        Public Shared Function InsertMessages(ByVal dt As SC3040101DataSet.SC3040101MessageInfoDataTable) As Integer
            ...
            Dim query As New DBUpdateQuery("SC3040101_001")

            'SQL組み立て
            Dim sql As New StringBuilder
            With sql
                .AppendLine("INSERT /* SC3040101_001 */ INTO TBL_MESSAGEINFO( ")
                .AppendLine("DLRCD, ")
                .AppendLine("STRCD, ")
