...
Partial Public Class SC3080205DataSet
    ...
    Partial Public Class SC3080205ZipDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSC3080205ZipRow(ByVal ADDRESS As String) As SC3080205ZipRow
    ...
    Partial Public Class SC3080205NameTitleDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSC3080205NameTitleRow(ByVal NAMETITLE_CD As String, ByVal NAMETITLE As String, ByVal DISPFLG As String) As SC3080205NameTitleRow
            Dim rowSC3080205NameTitleRow As SC3080205NameTitleRow = CType(Me.NewRow,SC3080205NameTitleRow)
            Dim columnValuesArray() As Object = New Object() {NAMETITLE_CD, NAMETITLE, DISPFLG}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByNAMETITLE_CD(ByVal NAMETITLE_CD As String) As SC3080205NameTitleRow
            Return CType(Me.Rows.Find(New Object() {NAMETITLE_CD}),SC3080205NameTitleRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnNAMETITLE_CD}, true))
            Me.columnNAMETITLE_CD.AllowDBNull = false
            Me.columnNAMETITLE_CD.Unique = true
    ...
    Partial Public Class SC3080205CustDataTable
        ...
        Public Overloads Function AddSC3080205CustRow( _
                    ...
                    ByVal VCLID As String) As SC3080205CustRow
            Dim rowSC3080205CustRow As SC3080205CustRow = CType(Me.NewRow,SC3080205CustRow)
            Dim columnValuesArray() As Object = New Object() {CUSTFLG, DLRCD, STRCD, STRCDSTAFF, STAFFCD, ORIGINALID, LINKSYSCD, CUSTCD, CUSTYPE, SOCIALID, NAME, SEX, BIRTHDAY, NAMETITLE, FIRSTNAME, MIDDLENAME, LASTNAME, FAMILYNAMEKANA, ONESNAMEKANA, COMPANYNAME, ADDRESS, ADDRESS1, ADDRESS2, ADDRESS3, DOMICILE, COUNTRY, ZIPCODE, TELNO, FAXNO, MOBILE, EMAIL1, EMAIL2, BUSINESSTELNO, INCOME, CONTACTTIME, OCCUPATION, FAMILY, NNAME, DEFAULTLANG, SMSFLG, WEBFLG, EMAILFLG, TELFLG, PAPCFLG, NAYOSECD, NAYOSELDVS, NAYOSEDATE, LEXUS_KUBUN, DELFLG, DELDATE, TAKEINDATE, CREATEDATE, UPDATEDATE, UPDATEACCOUNT, EMPLOYEENAME, EMPLOYEEDEPARTMENT, EMPLOYEEPOSITION, UPDATEFUNCFLG, NAMETITLE_CD, CSTID, ACTVCTGRYID, AC_MODFACCOUNT, AC_MODFFUNCDVS, REASONID, VIN, SERIESCODE, SERIESNAME, SMS_DISPLAYFLG, EMAIL_DISPLAYFLG, ORGINPUTFLG, POSTSRHFLG, DMAIL_DISPLAYFLG, VISITSEQ, DUMMYNAMEFLG, LOCKVERSION, VCLLOCKVERSION, VCLID}
    ...
    Partial Public Class SC3080205OmitreasonDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSC3080205OmitreasonRow(ByVal REASONID As String, ByVal REASON As String) As SC3080205OmitreasonRow
    ...
    Partial Public Class SC3080205SeqDataTable
        ...
        Private Sub InitClass()
            ...
            Me.columnSeq.DefaultValue = CType(0,Decimal)
        End Sub
