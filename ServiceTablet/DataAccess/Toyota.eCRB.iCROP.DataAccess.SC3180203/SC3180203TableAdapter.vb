...
Namespace SC3180203DataSetTableAdapter

    ''' <summary>
    ''' チェックシートプレビューデータアクセスクラス
    ''' </summary>
    ''' <remarks></remarks>
    Public NotInheritable Class SC3180203TableAdapter
        ...
        Public Shared Function GetCheckSheetHeader(ByVal dlrCd As String, _
            ...
            Using query As New DBSelectQuery(Of SC3180203HeaderDataDataTable)("SC3180203_001")
                Dim sql As New StringBuilder
                Dim headerDataDataTable As SC3180203HeaderDataDataTable
        ...
        Public Shared Function GetCheckSheetDetail(ByVal dlrCd As String, _
            ...
            Using query As New DBSelectQuery(Of SC3180203DetailDataDataTable)("SC3180203_002")
                Dim sql As New StringBuilder
                Dim detailDataDataTable As SC3180203DetailDataDataTable
        ...
        Public Shared Function GetModelDataTable(ByVal dlrCd As String, _
            ...
            Using query As New DBSelectQuery(Of SC3180203DetailDataDataTable)("SC3180203_003")
                Dim sql As New StringBuilder
        ...
        '    Using query As New DBSelectQuery(Of DataTable)("SC3180203_004", DBQueryTarget.DMS)
        '        Dim sql As New StringBuilder
        ...
        Public Shared Function GetItemCodeOrder(ByVal itemCode As String) As DataTable
            ...
            Using query As New DBSelectQuery(Of DataTable)("SC3180203_005")
                Dim sql As New StringBuilder
                Dim titleDataTable As New DataTable
        ...
        Public Function ChangeDlrStrCodeToICROP(ByVal dealerCD As String _
                                                       ...
                                                       , ByVal strBrnCd As String) As SC3180203DataSet.IcropCodeMapDataTable

            Dim No As String = "SC3180203_006"
            ...
            Try
                Dim dt As New SC3180203DataSet.IcropCodeMapDataTable
                Dim sql As New StringBuilder

                'SQL文作成
                With sql
                    .Append(" SELECT /* SC3180203_006 */ ")
                    .Append("        ICROP_CD_1 ")
                    .Append("      , ICROP_CD_2 ")
                ...
                Using query As New DBSelectQuery(Of SC3180203DataSet.IcropCodeMapDataTable)(No)
        ...
        Public Function IsExistServiceinActive(ByVal dlrCd As String, _
            ...
            Using query As New DBSelectQuery(Of DataTable)("SC3180203_007")
        ...
        ''' <remarks>点検組み合わせマスタに指定の販売店データが登録されているかをフラグで取得する</remarks>
        Public Function GetKatashikiExistMst(ByVal strRoNum As String, _
            ...
            Logger.Info(String.Format(CultureInfo.CurrentCulture _
                        ...
                        , System.Reflection.MethodBase.GetCurrentMethod.Name))
            Using query As New DBSelectQuery(Of DataTable)("SC3180203_008")
                Dim sql As New StringBuilder
                With sql
                    .Append("SELECT")
                    .Append("    /* SC3180203_008 */")
                    .Append("    CASE")
