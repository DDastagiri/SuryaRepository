...
Namespace SC3180205DataSetTableAdapters
    Public Class SC3180205DataTableAdapter
...
#Region "メイン"
        ...
        Public Function GetUserInfo(ByVal inDealerCode As String, _
            ...
            'データ格納用
            Dim dt As SC3180205UserInfoDataTable

            Dim sql As New StringBuilder

            'SQL文作成
            sql.AppendLine("   SELECT  /* SC3180205_001 */ ")
            sql.AppendLine("           CASE ")
            ...
            Using query As New DBSelectQuery(Of SC3180205UserInfoDataTable)("SC3180205_001")
...
Partial Class SC3180205DataSet
End Class
