...
#Region "初期処理"
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        titleCustomLabel.Text = Server.HtmlEncode(WebWordUtility.GetWord("SC3040101", 1))
        displayPeriodCustomLabel.Text = Server.HtmlEncode(WebWordUtility.GetWord("SC3040101", 4))
        ' 2012/04/26 TCS 藤井 【SALES_2】HtmlEncode対応 Modify End

        postButton.Text = WebWordUtility.GetWord("SC3040101", 5)

        ' 2012/04/26 TCS 藤井 【SALES_2】HtmlEncode対応 Modify Start
        postCustomLabel.Text = Server.HtmlEncode(WebWordUtility.GetWord("SC3040101", 5))
        ' 2012/04/26 TCS 藤井 【SALES_2】HtmlEncode対応 Modify End
...
#Region "入力チェック"
    ...
    Private Function ValidateSC3040101() As Boolean
        ...
        '2012/02/29 TCS 平野 【SALES_2】 START
        '表示期限の範囲チェック(過去日をエラーとする)
        Dim staffInfo As StaffContext = StaffContext.Current

        If displayPeriodCustomDateTimeSelector.Value < DateTimeFunc.Now(staffInfo.DlrCD).Date Then
            ShowMessageBox2(907)
            Return False
        End If
        '2012/02/29 TCS 平野 【SALES_2】 END
