<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SC3080214.ascx.vb" Inherits="PagesSC3080214" %>
    ...
    <link rel="Stylesheet" href="../Styles/SC3080214/SC3080214.css?20190611000001" type="text/css" media="screen,print"  />

    <%--2015/11/24 TR-SVT-TMT-20151026-001 Start--%>
    <%-- 二度押し制御とアクティブインジケータ表示の為、Import追加 --%>
    <script src="../Scripts/SC3080214/Common.js?20151126000001" type="text/javascript"></script>
    <%--2015/11/24 TR-SVT-TMT-20151026-001 End--%>

    <script src="../Scripts/SC3080214/SC3080214.js?20151126000000" type="text/javascript"></script>

	<div id="scNscCustomerLeftArea" class="contentsFrame" style="height: 240px;">

        <%--2015/11/24 TR-SVT-TMT-20151026-001 Start--%>
        <asp:HiddenField ID="InitHiddenField" runat="server" Value="0" />
        <%--2015/11/24 TR-SVT-TMT-20151026-001 End--%>
                ...
                <table border="0" class="NoBorderTable">
                    <tr>
                        <td style="width: 115px">
                            <asp:UpdatePanel ID="CustomerRelatedOccupationUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <%--2014/02/18 TMEJ 明瀬 次世代サービス 工程管理機能開発 START--%>
                                    <%--<div id="CustomerRelatedOccupationPopupArea" style="display:none; top: -290px;">--%>
                                    <div id="CustomerRelatedOccupationPopupArea" style="display:none;">
	                                <%--2014/02/18 TMEJ 明瀬 次世代サービス 工程管理機能開発 END--%>
                                        <div class="popUpHeader">
                                            <div class="btnL" style="display:none;">                                        
                                                <div>
                                                    <a onclick="setPopupOccupationPage('page1');" class="styleCut" >
                                                        <icrop:CustomLabel iD="CustomerRelatedOccupationCancelLabel" runat="server" TextWordNo="10125"></icrop:CustomLabel>
                                                    </a>
                                                    <asp:button ID="CustomerRelatedOccupationCancelButton" runat="server" style="display:none" />
                                                </div>
                                            </div>
                                            <h3 class="popUpTitle" >
                                                <icrop:CustomLabel ID="CustomerRelatedOccupationTitleLabel" runat="server" Width="195px" class="styleCut" TextWordNo="10122"></icrop:CustomLabel>
                                            </h3>
                                            <div class="btnR" style="display:none;">
                                                <div>
                                                    <asp:LinkButton ID="CustomerRelatedOccupationRegisterButton" runat="server" CssClass="styleCut" OnClientClick="return checkOtherOccupation();"></asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="popUpBG">
		                                    <div class="popUpArea" style="overflow:hidden;">
                                                <div id="CustomerRelatedOccupationPageArea" >
                                                    <asp:Panel ID="OccupationPopoverForm_1" runat="server" style="width:370px;float:left;height: 240px;">
                                                        <asp:Repeater ID="CustomerRelatedOccupationButtonRepeater" runat="server">
                                                            <ItemTemplate>
                                                                <asp:Panel ID="CustomerRelatedOccupationPanel" runat="server" CssClass="popUpIcon">
                                                                    ...
                                                                    <asp:LinkButton ID="CustomerRelatedOccupationHyperLink" runat="server" OnClientClick="return CustomerRelatedOccupationHyperLinkClik();">
	                                                                <%--2015/11/24 TR-SVT-TMT-20151026-001 End--%>
                                                                        <%--<icrop:CustomLabel ID="CustomerRelatedOccupationText" runat="server" Width="72px" UseEllipsis="True" CssClass="popupIconTextCenter ellipsis"></icrop:CustomLabel>--%>
                                                                        <icrop:CustomLabel ID="CustomerRelatedOccupationText" runat="server" Width="72px" UseEllipsis="True" CssClass="popupIconTextCenter ellipsis"></icrop:CustomLabel>
                                                                    </asp:LinkButton>
                        ...
                        <ContentTemplate>
                            ...
                            <div id="CustomerRelatedFamilyPopupArea" style="display:none;">
                            <%--2014/02/18 TMEJ 明瀬 次世代サービス 工程管理機能開発 END--%>
                                                            ...
                                                            <asp:Repeater ID="FamilyBirthdayList" runat="server">
                                                                <ItemTemplate>
                                                                    <li ID="FamilyBirthdayList_Row" runat="server" ClientIDMode="Predictable">
                                                                        ...
                                                                        <icrop:DateTimeSelector ID="FamilyBirthdayListBirthdayDate_Row" runat="server" CssClass="Calendar" ClientIDMode="Predictable" width="120px" Height="21px" Format="Date" PlaceHolderWordNo="10152" />
                    ...
                    <td style="width: 115px">
                        ...
                        <div id="CustomerRelatedHobbyPopupArea" style="display:none;">
                        <%--2014/02/18 TMEJ 明瀬 次世代サービス 工程管理機能開発 END--%>
	                        <div class="popUpHeader">
                            	<div class="btnL">
                                    <div>
                            ...
                            <%--2014/02/18 TMEJ 明瀬 次世代サービス 工程管理機能開発 END--%>
                                <div class="scNscPopUpContactSelectWindownBox WindownBox48">
                                    <div class="scNscPopUpContactSelectHeader">
                                        ...
                                        <div>
                                            <asp:LinkButton ID="ContactHeaderRegisterLinkButton" runat="server" CssClass="scNscPopUpContactCompleteButton styleCut" OnClientClick="return registContact();"></asp:LinkButton></div></div>
                                    <div class="scNscPopUpContactSelectListArea">
					        ...
					        <div class="scNscCustomerMemoPaper">
						        <asp:Panel ID="EditCustomerMemoPanel" runat="server" Visible="true" >
							        <p class="scNscCustomerMemoPaperDay">
                                        ...
                                        <asp:TextBox ID="CustomerMemoLabel" ReadOnly="true" MaxLength="1024" Width="438" Height="55" runat="server" TextMode="MultiLine" />
    ...
    <div style="display:none;">
        <asp:UpdatePanel ID="SC3080214CommonHidden" runat="server" UpdateMode="Always">
            <ContentTemplate>
