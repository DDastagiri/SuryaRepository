...
#Region "定数"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const APPLICATION_ID As String = "SC3170308"
...
#Region "イベント"
    ...
    Protected Sub MainAreaReload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MainAreaReload.Click
        ...
        Using biz As New SC3170308BusinessLogic
            Try
                'ユーザー情報取得
                Dim dtUserInfo As SC3170308UserInfoDataTable = biz.GetUserInfo(staffInfo.DlrCD, _
                                                                               staffInfo.BrnCD)
                '取得情報チェック
                If dtUserInfo IsNot Nothing AndAlso 0 < dtUserInfo.Count Then
                    ...
                    For i = 0 To Me.AccountAreaRepeater.Items.Count - 1
                        ...
                        'ROW取得
                        Dim drUserInfo As SC3170308UserInfoRow = _
                            CType(dtUserInfo.Rows(i), SC3170308UserInfoRow)
                        ...
                        CType(accountArea.FindControl("PresenceImage"), HtmlControl).Attributes("src") = _
                            String.Concat("../Styles/Images/SC3170308/", imageIcon)
