...
function commitCompleteOpenCustomerMemoEdit() {
    ...
    //入庫履歴の残像の対応
    $("#CustomerMemoEdit").css({ "z-index": "2" }).fadeIn(300);
...
// 2015/11/24 TM 浅野 TR-SVT-TMT-20151026-001 Start
function CustomerRelatedOccupationHyperLinkClik() {
    //職業選択イベント
...
function RegistCustomerRelatedFamily() {
    ...
    if (g_familyPage == "page1") {
        ...
        // 2015/11/24 TM 浅野 TR-SVT-TMT-20151026-001 Start
        //アクティブインジケータ表示フラグ：TURE表示
        gIsRegist = true;
        //2015/11/24 TM 浅野 TR-SVT-TMT-20151026-001 En
...
function setPopupContactPageOpen() {
    ...
    $(".scNscPopUpContactSelectListArea").fingerScroll();
