    ...
    var fn = {
        ...
        */
        setTranslate: function (data, position) {
            ...
            if (position.left < fn.constants.minLeft) { position.left = fn.constants.minLeft; }
            if (position.top < fn.constants.minTop) { position.top = fn.constants.minTop; }
        ...
        */
        init: function (param) {
            ...
            if (param.minLeft != null) {
                fn.constants.minLeft = param.minLeft;
            }

            if (param.minTop != null) {
                fn.constants.minTop = param.minTop;
            }
            //2013/01/09 Add End
        ...
        */
        stop: function (e) {
            ...
            if (Math.abs(top) > 0 || Math.abs(left) > 0 || src.overTopSize > 0 || src.overBottomSize > 0) {
                ...
                if (src.left < fn.constants.minLeft) { src.left = fn.constants.minLeft; }
                if (src.top < fn.constants.minTop) { src.top = fn.constants.minTop; }
                //2013/01/09 Add End
                //スクロール用のDIV
                e.data.inner.css({
...
//            return rate !== 1;
    ...
    $.fn.SC3100303FingerScroll = function (param) {
