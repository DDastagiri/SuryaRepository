...
(function ($, window, Math, undefined) {
    ...
    $.fn.SC3250106Flickable = flickable = function (options) {
    ...
    flickable.prototype = {
        ...
        scroll: function (x, y) {
            ...
            self.trigger('onScrolling', null, null);
            return this;
        },
        ...
        drag: function (event) {
            ...
            //modified!
            if ((Math.abs(event.pageX - this.dragStartX) < 50) && (Math.abs(event.pageY - this.dragStartY) < 50)) {
                return;
            }
        ...
        select: function (index) {
            ...
            this.inertia = setInterval(function () {
                ...
                if (self.options.disabled || !self.isScrolling()) {
                    clearInterval(self.inertia);
                    self.scrollBack();
                 //   self.trigger('finishselect', null, null);
                    return;
                }
