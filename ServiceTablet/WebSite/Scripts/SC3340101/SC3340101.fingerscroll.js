...
(function (window) {
    ...
    var fn = {
        ...
        */
        setTranslate: function (data, position) {
            ...
            //            }
            //            //2014/08/14 TMEJ 丁 メインメニュー(移動マン) END
            data.inner.css({ "transform": "translate3d( 0px," + position.top + "px, 0px)" });
        },
        ...
        */
        drag: function (e) {
            ...
            //2015/01/05 TMEJ 範  NextSTEPサービス 洗車用端末開発向けた評価用アプリ作成 START
            if (y < 300) {
            ...
            //2015/01/05 TMEJ 範  NextSTEPサービス 洗車用端末開発向けた評価用アプリ作成 END
    ...
    $.fn.SC3340101fingerScroll = function (param) {
