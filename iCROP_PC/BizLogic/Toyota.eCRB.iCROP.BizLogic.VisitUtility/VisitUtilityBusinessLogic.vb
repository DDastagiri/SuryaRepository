...
#Region "ユーザー情報の取得"
    ...
    Public Function GetUsers(ByVal dealerCode As String,
                             ...
                             Optional ByVal deleteCode As String = Nothing) As VisitUtilityUsersDataTable
        Logger.Info("GetUsers_Start Param[" & dealerCode & ", " _
                     ...
                     & "deleteFlag is Nothing:" & IsNothing(deleteCode).ToString & "]")
        ...
        Dim usersDataTable As VisitUtilityUsersDataTable
        usersDataTable = VisitUtilityDataSetTableAdapter.GetUsers(dealerCode, storeCode, operationCodeList, presenceCategoryList, deleteCode)
