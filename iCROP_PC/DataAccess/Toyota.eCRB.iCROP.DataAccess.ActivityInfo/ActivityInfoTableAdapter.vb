...
Public Class ActivityInfoTableAdapter
...
#Region "メソット"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwSeries(ByVal dlrcd As String, ByVal strcd As String, ByVal cntcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoFllwSeriesDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwSeriesDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    E.SEQNO, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwModel(ByVal dlrcd As String, ByVal strcd As String, ByVal cntcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoFllwModelDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
            .Append("    SEL.SEQNO, ")
            ...
            .Append("    SEQNO ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwModelDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)
            query.AddParameterWithTypeValue("CNTCD", OracleDbType.Char, cntcd)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwColor(ByVal dlrcd As String, ByVal strcd As String, ByVal cntcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoFllwColorDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
            .Append("    FLL.SEQNO, ")
            ...
            .Append("    SEQNO ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwColorDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)
            query.AddParameterWithTypeValue("CNTCD", OracleDbType.Char, cntcd)
    ...
    Public Shared Function GetActHisCarSeq(ByVal dlrcd As String, ByVal strcd As String,
                                           ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoSeqDataTable
    ...
    Public Shared Function GetVclinfo(ByVal originalid As String, ByVal vin As String) As ActivityInfoDataSet.ActivityInfoSeriesDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSeriesDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetNewcustVclinfo(ByVal cstid As String, ByVal seqno As Long) As ActivityInfoDataSet.ActivityInfoSeriesDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function GetNewCustID(ByVal originalid As String) As ActivityInfoDataSet.ActivityInfoNewCustIDDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoNewCustIDDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    CSTID ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetNewVclID(ByVal cstid As String, ByVal vin As String) As ActivityInfoDataSet.ActivityInfoNewVclIDDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
            .Append("    SEQNO ")
            ...
            .Append("    VIN = :VIN ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoNewVclIDDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("CSTID", OracleDbType.Char, cstid)
            query.AddParameterWithTypeValue("VIN", OracleDbType.Char, vin)
            Return query.GetData()
    ...
    Public Shared Function GetSeqNewcustomerCstId() As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function InsertNweCustomer(ByVal cstid As String, ByVal originalid As String, ByVal vin As String) As Integer
        Dim sql As New StringBuilder
        With sql
            .Append("INSERT /* ActivityInfo_000 */ ")
            .Append("INTO ")
            .Append("    TBL_NEWCUSTOMER ")
            .Append("( ")
            .Append("    CSTID, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetMakername(ByVal dlrcd As String, ByVal cntcd As String, ByVal seriescd As String) As ActivityInfoDataSet.ActivityInfoMakernameDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
            .Append("    M.MAKERNAME ")
        ...
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoMakernameDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)
            query.AddParameterWithTypeValue("CNTCD", OracleDbType.Char, cntcd)
    ...
    ''' <summary>
    ''' 037.未取引客車両情報追加SeqNo取得
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSeqNewcustomerVclreSeqno() As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    ''' <summary>
    ''' 034.Walk-in Person SeqNo取得
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSeqWalkInPersonWalkInId() As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSeqTotalhisSeqno() As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function GetServiceStaff(ByVal originalid As String, ByVal vin As String) As ActivityInfoDataSet.ActivityInfoServiceStaffDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoServiceStaffDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function GetWinclass(ByVal wicid As String) As ActivityInfoDataSet.ActivityInfoWinclassDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoWinclassDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    WICNAME, ")
    ...
    Public Shared Function GetVin(ByVal originalid As String) As ActivityInfoDataSet.ActivityInfoVinDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoVinDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    VIN ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetMileageHis(ByVal originalid As String, ByVal vin As String) As ActivityInfoDataSet.ActivityInfoMileageHisDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoMileageHisDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    DLRCD, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetServiceHis(ByVal dlrcd As String, ByVal jobno As String) As ActivityInfoDataSet.ActivityInfoServiceHisDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoServiceHisDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    DLRCD, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetServiceMaster(ByVal mntncd As String, ByVal dlrcd As String) As ActivityInfoDataSet.ActivityInfoServiceMasterDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoServiceMasterDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    SERVICECD, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSubCategory(ByVal servicecd As String) As ActivityInfoDataSet.ActivityInfoSubCategoryDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSubCategoryDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    SUBCTGCODE ")
    ...
    ''' <summary>
    ''' 047.Follow-upBox結果の最大SeqNo+1を取得
    ''' </summary>
    ''' <param name="dlrcd"></param>
    ''' <param name="strcd"></param>
    ''' <param name="fllwupboxseqno"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwRsltSeq(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function GetActHisFllw(ByVal dlrcd As String, ByVal strcd As String,
                                           ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoActHisFllwDataTable
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetActHisCarSeq(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long, ByVal seqno As Long, ByVal cntcd As String) As ActivityInfoDataSet.ActivityInfoActHisSelCarDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_000 */ ")
            .Append("    FLL.SERIESNM, ")
            ...
            .Append("    FLL.COLORCD = E.BODYCLR_CD (+) ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoActHisSelCarDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Int64, fllwupboxseqno)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwupBox(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoFllwupBoxDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwupBoxDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    A.CRPLAN_ID, ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwupboxRslt(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoFllwupboxRsltDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwupboxRsltDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    Public Shared Function GetCompetition(ByVal competitionmakerno As String, ByVal competitorcd As String) As ActivityInfoDataSet.ActivityInfoCompetitionDataTable
        ...
        With sql
            ...
            .Append("FROM DUAL ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoCompetitionDataTable)("ActivityInfo_000")
            query.CommandText = sql.ToString()
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetFllwupboxEntry(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoCountDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoCountDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    1 ")
    ...
    Public Shared Function GetFllwupboxrsltDone(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long,
                                                ByVal doneCategory As String) As ActivityInfoDataSet.ActivityInfoFllwupboxrsltDoneDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoFllwupboxrsltDoneDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    ACTENDFLG ")
    ...
    ''' <summary>
    ''' 035.非活動対象要件情報SeqNo取得
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSeqInreserveInfoInreserveId() As ActivityInfoDataSet.ActivityInfoSequenceDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSequenceDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetSelectedCarNum(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long, ByVal seqno As String) As ActivityInfoDataSet.ActivityInfoSelectedCarNumDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoSelectedCarNumDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    QUANTITY ")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetOtherPlanFllw(ByVal dlrcd As String, ByVal strcd As String, ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoCountDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoCountDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
    ...
    ''' <summary>
    ''' 045.その他計画(Follow-up)追加(活動結果登録時) 
    ''' </summary>
    ...
    Public Shared Function InsertOtherPlanFllwRslt(ByVal strcategory As String, ByVal strcrresult As String,
        ...
        Dim sql As New StringBuilder
        With sql
            .Append(" INSERT INTO /* ActivityInfo_000 */ TBL_OTHERPLAN_FLLW ")
            .Append(" ( ")
            .Append("  DLRCD ")
            .Append(" ,STRCD ")
            .Append(" ,FLLWUPBOX_SEQNO ")
    ...
    ''' <summary>
    ''' 046.その他計画(Follow-up)更新(活動結果登録時)
    ''' </summary>
    ''' <param name="planstatus"></param>
    ''' <param name="cractresult"></param>
        ...
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoActContactDataTable)("ActivityInfo_001")
            ...
            With sql
                ...
                If (String.IsNullOrEmpty(bookedafterflg) = False) Then
                    .Append(" AND   BOOKEDAFTERFLG = :BOOKEDAFTERFLG ")
                End If
                .Append("ORDER BY ")
                .Append("    SORTNO ")
            End With
            ...
            query.CommandText = sql.ToString()
            If (String.IsNullOrEmpty(bookedafterflg) = False) Then
                query.AddParameterWithTypeValue("BOOKEDAFTERFLG", OracleDbType.Char, bookedafterflg)                  '受注後フラグ
            End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function CountFllwupboxRslt(ByVal dlrcd As String, _
                                              ByVal strcd As String, _
                                              ByVal fllwupboxseqno As Long, _
                                              ByVal cractresult As String) As Integer

        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_002 */ ")
            .Append("       COUNT(1) AS CNT ")
            .Append("  FROM TBL_FLLWUPBOXRSLT ")
            .Append(" WHERE DLRCD = :DLRCD ")     '販売店コード
            .Append("   AND STRCD = :STRCD ")     '店舗コード
            .Append("   AND FLLWUPBOX_SEQNO = :FLLWUPBOX_SEQNO ") 'Follow-up Box内連番
            .Append("   AND CRACTRESULT = :CRACTRESULT ") 'CR活動結果
            .Append("   AND ROWNUM <= 1 ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoCountDataTable)("ActivityInfo_002")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Long, fllwupboxseqno)
    ...
    Public Shared Function GetContractNo(ByVal dlrcd As String,
                                         ByVal strcd As String,
                                         ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoContractNoDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_003 */ ")
            '.Append("       CONTRACTNO ")
            .Append("  DECODE(NVL(B.CANCELFLG,''), '1', '', A.CONTRACTNO) AS CONTRACTNO ")
            .Append("  FROM TBL_ESTIMATEINFO A ")
            .Append("       ,TBL_SALESBKGTALLY B ")
            .Append(" WHERE A.DLRCD = :DLRCD ")
            .Append("   AND A.STRCD = :STRCD ")
            .Append("   AND A.FLLWUPBOX_SEQNO = :FLLWUPBOX_SEQNO ")
            .Append("   AND A.DELFLG = '0' ")
            .Append("   AND A.CONTRACTFLG = '1' ")
            .Append("   AND A.DLRCD = B.DLRCD(+) ")
            .Append("   AND A.CONTRACTNO = B.SALESBKGNO(+) ")
            '.Append("   AND B.CANCELFLG(+) = '0' ")
            '.Append("   AND B.CUSTDELFLG(+) = '0' ")
        ...
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoContractNoDataTable)("ActivityInfo_003")
            ...
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Long, fllwupboxseqno)    'Follow-up Box内連番
            Return query.GetData()
        End Using
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetProcessAfter(ByVal dlrcd As String,
                                           ByVal salesbkgno As String) As ActivityInfoDataSet.ActivityInfoGetProcessAfterDataTable

        Dim sql As New StringBuilder
        With sql
            .Append(" SELECT /* ActivityInfo_004 */ ")
            .Append("     SALESBKGDATE ")
            .Append("     ,NVL(VCLASIDATE, VCLASIDATE_ENT) AS VCLASIDATE ")
            .Append("     ,NVL(SALESDATE, SALESDATE_ENT) AS SALESDATE ")
            .Append("     ,NVL(VCLDELIDATE, VCLDELIDATE_ENT) AS VCLDELIDATE ")
            .Append(" FROM ")
            .Append("     TBL_SALESBKGTALLY A ")
            .Append(" WHERE ")
            .Append("     A.DLRCD = :DLRCD  ")
            .Append("     AND A.SALESBKGNO = :SALESBKGNO ")
            .Append("     AND A.CANCELFLG = '0' ")
            .Append("     AND A.CUSTDELFLG = '0' ")
            .Append("     AND A.DELFLG = '0' ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetProcessAfterDataTable)("ActivityInfo_004")

            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)                          '販売店コード
            query.AddParameterWithTypeValue("SALESBKGNO", OracleDbType.Char, salesbkgno)                'SALESBKGNO
    ...
    Public Shared Function GetProcess(ByVal dlrcd As String,
                                      ByVal strcd As String,
                                      ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoGetProcessDataTable

        Dim sql As New StringBuilder
        With sql
            .Append(" SELECT /* ActivityInfo_005 */ ")
            .Append("     SEQNO SEQNO ")
            ...
            .Append("     ,ACTIONCD ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetProcessDataTable)("ActivityInfo_005")
    ...
    Shared Function GetStatus(ByVal dlrcd As String,
                              ByVal strcd As String,
                              ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoGetStatusDataTable

        Dim sql As New StringBuilder
        With sql
            .Append(" SELECT /* ActivityInfo_006 */ ")
            .Append("     CRACTRESULT ")
            .Append(" FROM ")
            .Append(" ( ")
            .Append("     (SELECT ")
            ...
            .Append(" ) ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetStatusDataTable)("ActivityInfo_006")
    ...
    Shared Function GetSelectedSeries(ByVal dlrcd As String,
                                      ...
                                      ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoGetSelectedSeriesDataTable

        Dim sql As New StringBuilder
        With sql
            .Append(" SELECT /* ActivityInfo_007 */ ")
            .Append("     J.SERIESCD ")
            .Append("     ,J.SERIESNM ")
            .Append("     ,J.MODELCD ")
            ...
            .Append("     J.SEQNO ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetSelectedSeriesDataTable)("ActivityInfo_007")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)                          '販売店コード
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)                          '店舗コード
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Shared Function GetSuccessSeries(ByVal dlrcd As String,
                                      ByVal strcd As String,
                                      ByVal fllwupboxseqno As Long) As ActivityInfoDataSet.ActivityInfoGetSelectedSeriesDataTable

        Dim sql As New StringBuilder
        With sql
            .Append(" SELECT /* ActivityInfo_008 */ ")
            .Append("     B.SERIESCD ")
            .Append("     ,B.SERIESNM ")
            .Append("     ,B.MODELCD ")
            .Append("     ,B.MODELNM VCLMODEL_NAME ")
            .Append("     ,B.EXTCOLORCD COLORCD ")
            .Append("     ,B.EXTCOLOR DISP_BDY_COLOR")
            .Append("     ,C.IMAGEFILE PICIMAGE ")
            .Append("     ,D.LOGO_NOTSELECTED LOGOIMAGE ")
            .Append("     ,1 QUANTITY ")
            .Append("     ,E.SEQNO SEQNO")
            .Append(" FROM ")
            ...
            .Append("     SELECT  ")
            .Append("      ESTIMATEID ")
            'モデルコード(MODELCD)の先頭14文字＝AHV41L-JEXGBC/の場合は、SERIESCDを固定で'CMYHV'にする。
            .Append("     ,DECODE(SUBSTR(MODELCD,0,14),'AHV41L-JEXGBC/','CMYHV',SERIESCD) AS SERIESCD ")
            .Append("     ,SERIESNM ")
            .Append("     ,MODELCD ")
            .Append("     ,MODELNM")
            .Append("     ,EXTCOLORCD")
            .Append("     ,EXTCOLOR")
            .Append("     FROM TBL_EST_VCLINFO ")
            .Append("    ) B  ")

            .Append("     ,TBL_MODELPICTURE C ")
            .Append("     ,TBL_MODELLOGO D ")
            .Append("     ,TBL_FLLWUPBOX_SELECTED_SERIES E")
            .Append("     ,TBL_MSTCARNAME F")
            .Append(" WHERE ")
            .Append("     A.ESTIMATEID = B.ESTIMATEID ")
            .Append("     AND A.DLRCD = :DLRCD ")
            .Append("     AND A.STRCD = :STRCD ")
            .Append("     AND A.FLLWUPBOX_SEQNO = :FLLWUPBOX_SEQNO ")
            .Append("     AND C.DLRCD(+) = 'XXXXX' ")
            .Append("     AND E.SERIESCD = C.SERIESCD  ")
            .Append("     AND NVL(B.MODELCD,' ') = C.MODELCD(+) ")
            .Append("     AND NVL(B.EXTCOLORCD,' ') = C.COLORCD(+) ")
            .Append("     AND D.DLRCD(+) = 'XXXXX' ")
            .Append("     AND E.SERIESCD = D.SERIESCD(+) ")
            .Append("     AND A.DLRCD = E.DLRCD ")
            .Append("     AND A.STRCD = E.STRCD ")
            .Append("     AND A.FLLWUPBOX_SEQNO = E.FLLWUPBOX_SEQNO ")
            '.Append("     AND B.SERIESCD = E.SERIESCD ")
            .Append("     AND NVL(B.MODELCD,' ') = E.MODELCD ")
            .Append("     AND NVL(B.EXTCOLORCD,' ') = E.COLORCD ")
            .Append("     AND B.SERIESCD = F.VCLSERIES_CD ")
            .Append("     AND E.SERIESCD = F.CAR_NAME_CD_AI21 ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetSelectedSeriesDataTable)("ActivityInfo_008")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)                          '販売店コード
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)                          '店舗コード
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Int64, fllwupboxseqno)      'fllwupbox_seqno
    ...
    ''' <param name="salesbkgno">受注No</param>
    ''' <returns>データセット</returns>
    ''' <remarks>受注後工程を取得する</remarks>
    Public Shared Function GetWaitingObject(ByVal dlrcd As String,
                                            ByVal salesbkgno As String) As ActivityInfoDataSet.ActivityInfoWaitingObjectDataTable
        Dim sql As New StringBuilder
        With sql
            .Append("SELECT /* ActivityInfo_009 */ ")
            .Append("       WAITING_OBJECT WAITINGOBJECT ")
            .Append("  FROM TBL_SALESBKGTALLY ")
            .Append(" WHERE DLRCD = :DLRCD ")
            .Append("   AND SALESBKGNO = :SALESBKGNO ")
            .Append("   AND DELFLG = '0' ")
            .Append("   AND CANCELFLG = '0' ")
            .Append("   AND CUSTDELFLG = '0' ")
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoWaitingObjectDataTable)("ActivityInfo_009")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)                       '販売店コード
    ...
    ''' <returns>契約日</returns>
    ''' <remarks></remarks>
    Public Shared Function GetContractDate(ByVal dlrcd As String, _
                                             ByVal strcd As String, _
                                             ByVal seqno As Long) As ActivityInfoDataSet.ActivityInfoGetContractDateDataTable
        ...
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoGetContractDateDataTable)("ActivityInfo_010")
            ...
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrcd)                  '販売店コード
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strcd)                  '店舗コード
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Int64, seqno)       'Follow-up Box内連番
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetLatestActTimeEnd(dlrCD As String, strCD As String, fllwupboxSeqNo As Long) As ActivityInfoDataSet.ActivityInfoLatestActTimeDataTable
        Dim sql As New StringBuilder
        With sql
            '2012/04/17 TCS 河原 【SALES_2】号口課題No.118 START
            .Append("SELECT /* ActivityInfo_012 */")
            ...
            .Append("        FLLWUPBOX_SEQNO = :FLLWUPBOX_SEQNO")
            .Append("  UNION ALL")
            .Append("  SELECT SALESENDTIME LATEST_TIME_END ")
            .Append("  FROM TBL_BOOKEDAFTERFOLLOWRSLT")
            .Append("  WHERE DLRCD = :DLRCD AND ")
            .Append("        STRCD = :STRCD AND ")
            .Append("        FLLWUPBOX_SEQNO = :FLLWUPBOX_SEQNO")
            .Append(")")
            '2012/04/17 TCS 河原 【SALES_2】号口課題No.118 END
        End With
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.ActivityInfoLatestActTimeDataTable)("ActivityInfo_012")
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("DLRCD", OracleDbType.Char, dlrCD)
            query.AddParameterWithTypeValue("STRCD", OracleDbType.Char, strCD)
            query.AddParameterWithTypeValue("FLLWUPBOX_SEQNO", OracleDbType.Int64, fllwupboxSeqNo)
    ...
    Public Shared Function GetNewCustomer(ByVal custId As String) As ActivityInfoDataSet.GetNewCustomerDataTable
        Using query As New DBSelectQuery(Of ActivityInfoDataSet.GetNewCustomerDataTable)("ActivityInfo_000")
            Dim sql As New StringBuilder
            With sql
                .Append("SELECT /* ActivityInfo_000 */ ")
                .Append("    NAME, ")
            ...
            query.CommandText = sql.ToString()
            query.AddParameterWithTypeValue("CSTID", OracleDbType.Char, custId)
